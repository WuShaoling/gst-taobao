...
## 1. build hadoop:base image(install mysql)
host:
```
# docker run -d cloudwarelabs/xfce4-pulsar-ide
...
host:
```
# docker commit {your-container-id} hadoop:base
```

## 2. build hadoop:v1.0 image
```
# cd hadoop-v1.0
# docker build -t hadoop:v1.0 .
```

## 3. build hadoop:v2.0 image
